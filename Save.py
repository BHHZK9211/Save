#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Z K HACKER
...
\033[1;91m██████╗  ██║░╚██╗
\033[1;91m╚═════╝  ╚═╝░░╚═╝
\033[1;97m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;94mZ K TECH\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•
\033[1;91m:•◈•
\033[1;91m╭━━━━╮╭╮╭━╮╭╮╱╭┳━━━┳━━━┳╮╭━┳━━━┳━━━╮
\033[1;91m╰━━╮━┃┃┃┃╭╯┃┃╱┃┃╭━╮┃╭━╮┃┃┃╭┫╭━━┫╭━╮┃
\033[1;91m╱╱╭╯╭╯┃╰╯╯╱┃╰━╯┃┃╱┃┃┃╱╰┫╰╯╯┃╰━━┫╰━╯┃
...
jalan('\033[1;91m=========90%')😇
jalan('\033[1;91m==========100%')😎
print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;94mZ K TECH\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"

CorrectUsername = "savezk"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Z K HACKER
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;94mSAVE\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Z K HACKER
	print logo
...
def super():
	...
	print "\033[1;97m-•◈•-\033[1;97m> \033[1;97m2.\x1b[1;94mClone Friend List Public ID."
        print "\033[1;97m-•◈•-\033[1;97m> \033[1;97m3.\x1b[1;94mClone Group ID."
...
def pilih_super():
	...
	if peak =="0":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;94mSAVE ZK \033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
		...
		print"\033[1;94mGetting Group IDs\033[1;97m..."
			...
			print   "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;94mLOVE ZK\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;94mSAVE Z K TECH\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;94m«---•◈•---Developed By Z K---•◈•---»" #Dev:Z K HACKER
	print "\033[1;94m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Save.py)↩\033[1;97m...."
	...
	print """
             ...
             ▒▓▒▓▒▒║░░░░░░░║▒▒▓▒▓▒
             ──────╚═══════╝──────    
             Checkpoint ID Open After 5 to 7 Days

•\033[1;97m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;94m .....Z K HACKER  YOUTUBE Z K TECH...LINK....https://www.youtube.com/channel/UChfXBYlQ3qW6KJQpIH601uA..... \033[1;97m :
•\033[1;97m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                FACEBOOK ACCOUNT
              \033[1;94m www.facebook.com/aamirzk420"""
